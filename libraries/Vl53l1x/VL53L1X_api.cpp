...
void vl53l1x_init(void) {
    ...
    status += vl53l1x_set_timing_budgetIn_ms(Dev, 10);
    status += vl53l1x_set_inter_measurementIn_ms(Dev, 10);
    status += vl53l1x_start_ranging(Dev);
}
...
void vl53l1x_get_mode(vl53l1x_mode_t* mode) {
    memcpy(mode, &vl53l1x_mode, sizeof(vl53l1x_mode_t));
}
...
void vl53l1x_set_mode(vl53l1x_mode_t* mode) {
    memcpy(&vl53l1x_mode, mode, sizeof(vl53l1x_mode_t));
    if (vl53l1x_mode.vl53l1x_distance == VL53_DISTANCE_SHORT) {
        vl53l1x_set_distance_mode(Dev, 1);
    } else {
        vl53l1x_set_distance_mode(Dev, 2);
    }
}
...
void vl53l1x_enable(void) {
    vl53l1x_mode.enable = true;

    vl53l1x_sensor_init(0);
    vl53l1x_set_timing_budgetIn_ms(0, 10);
    vl53l1x_set_inter_measurementIn_ms(0, 10);
